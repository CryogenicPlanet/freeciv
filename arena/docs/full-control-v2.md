...
[`arena/archive/play/docs/full-control-v2.openapi.json`](../archive/play/docs/full-control-v2.openapi.json),
with a concise custom-harness loop in
[`arena/archive/play/docs/custom-harness-v2.md`](../archive/play/docs/custom-harness-v2.md).

...
3. **Bounds tuned to the wrong budget.** `MAX_PAGE_ITEMS = 16`
   (`arena/archive/agent_eval/v2_control.py:37`) protects nothing the 64KB byte cap doesn't
...
fail CI the same way a scoring bug does. `arena/archive/agent_eval/tests` gains a golden

...
- [Player HTTP contract](../archive/play/docs/custom-harness-v2.md) and
  [OpenAPI 3.1](../archive/play/docs/full-control-v2.openapi.json) — the bounded,
  authenticated custom-harness surface.

Related source documentation:

- [Agent session contract](../archive/agent_eval/README.md)

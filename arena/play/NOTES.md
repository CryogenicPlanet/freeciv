...
- `arena/archive/agent_eval/supervisor.py:125` — `V2_TIMING_MODE_TIMEOUTS = {"default": 600.0, …}`, fed
...
- `arena/archive/agent_eval/supervisor.py:288` — `V2_AUTO_END_IDLE_GRACE_S = 20.0`, returned verbatim as
...
`arena/archive/agent_eval/supervisor.py` that writes it. It is a claim about the **field**, not about the

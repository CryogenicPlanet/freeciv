 ...
 * but `f"{harness}-{model}"` (`arena/archive/agent_eval/play_setup.py`). Splitting that back
 ...
 * `arena/archive/agent_eval/play_setup.py`. Adding one there means adding it here and dropping
...
/** The model vendors behind `MODEL_CHOICES` in `arena/archive/agent_eval/play_setup.py`. */
